...
ActiveRecord::Schema.define(version: 20161129151824) do
  ...
  create_table "cat_fols", force: :cascade do |t|
    t.integer  "user_id"
  ...
  create_table "categories_followings", force: :cascade do |t|
    t.integer  "user_id"
    t.integer  "category_id"
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
  ...
  create_table "catfols", force: :cascade do |t|
    t.integer  "user_id"
    t.integer  "category_id"
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
